...
\usepackage{setspace} % Reduce spacing in the list of acronyms
...
\usepackage[
    ...
    % citestyle=apa,
    % sorting=none,
    sorting=nyt, % to spot duplicate references
    natbib=true,
    backend=biber, 
    % maxcitenames=1, 
    % maxbibnames=99
...
\input{chapters/0-cover}
\newpage

\pagenumbering{roman}
\setcounter{page}{1}
\input{chapters/0.1-affirmation}
\input{chapters/0.2-acknowledgements}
\input{chapters/0.3-publication-list}
\input{chapters/0.4-abstract}
\input{chapters/0.5-tocs-and-lists}

% MAIN THESIS
\setcounter{page}{1}
\pagenumbering{arabic}
\input{chapters/1-introduction}
\input{chapters/2-synthetic-data-review}
\input{chapters/3-gsmotenc}
\input{chapters/4-kmeans-smote-lulc}
\input{chapters/5-al-generator-lulc}
\input{chapters/6-active-learning-augmentation}
