...
\input{figures/gsmotenc/datasets_description.tex}
...
\input{figures/gsmotenc/mean_sem_ranks.tex}
}
\endgroup
...
\input{figures/gsmotenc/mean_sem_scores.tex}
}
\endgroup
...
\input{figures/gsmotenc/friedman_test.tex}
...
\input{figures/gsmotenc/holms_test.tex}
...
Fonseca, J., Bacao, F. (2023). Geometric SMOTE for Imbalanced Datasets with
Nominal and Continuous Features. Submitted to Expert Systems with Applications
(waiting for 2nd set of reviews).
